...
public class BookRegister extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        bookRate = new javax.swing.JTextField();
        ...
        bookTitle.setBorder(javax.swing.BorderFactory.createTitledBorder(""));

        bookAuthor.setBorder(javax.swing.BorderFactory.createTitledBorder("Autor"));

        bookRate.setBorder(javax.swing.BorderFactory.createTitledBorder("Nota (0 - 10)"));
                ...
                jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addComponent(bookAuthor, javax.swing.GroupLayout.PREFERRED_SIZE, 56,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
                                .addComponent(bookRate, javax.swing.GroupLayout.PREFERRED_SIZE, 56,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void registerBookButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_registerBookButtonActionPerformed
        ...
        try {
            ...
            } else if (Integer.parseInt(bookRate.getText()) < 0 || Integer.parseInt(bookRate.getText()) > 10) {
                JOptionPane.showMessageDialog(null, "A nota deve ser entre 0 e 10!");
            } else {
                int bookId = dao.getLastId();
                int userId = User.user.getId();
                int rating = Integer.parseInt(bookRate.getText());
                Rate rate = new Rate(userId, bookId, rating);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BookRegister.class.getName()).log(
    ...
    private javax.swing.JTextField bookRate;
